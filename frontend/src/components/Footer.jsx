      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-10 sm:py-14 lg:px-10">
        <div className="grid gap-8 sm:gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-[1.3fr_0.85fr_0.85fr] md:items-start">
          <div className="flex flex-col gap-3 sm:gap-4">
            <h3 className="font-serif text-2xl sm:text-3xl text-white">Story Store</h3>
            <p className="max-w-sm text-xs sm:text-sm leading-5 sm:leading-6 text-[#c9ceda]">
              A place to discover, write, and keep coming back to the stories you love.
            </p>
          </div>

          <div className="flex flex-col gap-3 sm:gap-4">
            <Link to="/stories" className="inline-flex w-fit text-xs sm:text-sm font-semibold uppercase tracking-[0.3em] text-[#d7b88c] transition hover:text-white">
              Explore
            </Link>
            <ul className="mt-2 sm:mt-4 space-y-2 sm:space-y-3 text-xs sm:text-sm">
          ...
          <div className="flex flex-col gap-3 sm:gap-4">
            <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-[0.3em] text-[#d7b88c]">Contact</h4>
            <div className="mt-2 sm:mt-4 space-y-2 sm:space-y-3 text-xs sm:text-sm text-[#d9dde6]">
        ...
        <div className="mt-8 sm:mt-10 flex flex-col gap-3 border-t border-white/10 pt-5 sm:pt-6 text-xs sm:text-sm text-[#aab3c4] sm:flex-row sm:items-center sm:justify-between">
